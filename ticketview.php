...
<html>
<head>
<title>View Ticket - Call Center Ticketing Management System</title>
...
<body id="view-ticket" style="background-color:#f1f1f1;">
	<!-- menu-admin -->
...
<span id="error" style="display: none; color:red;"></span>
  ...
  <div class="form-row">
    <div class="form-group col-md-3">
      ...
      <textarea type="text" class="form-control" rows="4"  style="resize: none;" id="newdescription" name="newdescription" readonly><?php echo htmlspecialchars ($pizza['description']); ?></textarea>
    </div>

	<div class="form-group col-md-3">
      <label for="solution">Solution/Reason<span style="color:red;">*</span></label>
      <textarea type="text" style="background-color:#f1f1f1; resize: none;" class="form-control" rows="4"   id="solution"
	...
	<div class="form-group col-md-3">
      <label for="newassign">Assigned To<span style="color:red;">*</span></label>
	   <input type="text" class="form-control" id="newassign" name="newassign" value="<?php echo htmlspecialchars($pizza['assignedto']); ?>" style="background-color:#f1f1f1;">
    </div>
  ...
  <div class="form-row">
  <div class="form-group col-md-3">
	<label for="closedate">Date Closed <span style="color:red;">*</span></label>
      <input type="text" id="datepicker" class="form-control"  name="closedate" placeholder="Close Date" style="background-color:#f1f1f1;">
	  <script>
  ...
  <button type="submit" name="submit" class="btn btn-success">Close Ticket</button>
  <button type="cancel" name="cancel" class="btn btn-danger" style="margin-left:2vw;"><a href="http://localhost/TicketingMain/assigned_tickets.php" style="text-decoration:none; color:#fff;">Cancel</a></button>
</form>
...
<script type="text/javascript">
 $(document).ready(function($){
    ...
    $('#ajax-form').submit(function(e){
        ...
        if(solution == ""){
            $("#error").fadeIn().text("Ticket Solution required.");
      ...
      var newstatus = $("select#newstatus").val();
		...
		// status required
      var newassign = $("input#newassign").val();
        if(newassign == ""){
            $("#error").fadeIn().text("Assignee required");
            $("input#newassign").focus();
            return false;
        }

		// purchase date required
      var closedate = $("input#datepicker").val();
        if(closedate == ""){
            $("#error").fadeIn().text("Close Date required");
